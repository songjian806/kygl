<%@page import="org.apache.poi.util.List2d" %>
                    ...
                    <section class="panel">
                        ...
                        <table class="table table-striped table-bordered" id="sample_1">
                            ...
                            <tr>
                                ...
                                <th>
                                    <div align="center">项目批次</div>
                                </th>
                                <th>
                                    <div align="center">项目成员</div>
                                </th>
                                <th>
                                    <div align="center">负责人</div>
                                </th>
                                <th>
                                    <div align="center">负责人学工号</div>
                                </th>
                                <th>
                                    <div align="center">系审核状态</div>
                                </th>
                                <th>
                                    <div align="center">校审核状态</div>
                                </th>
                                <th style="width:12%">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td align="center"><%=project1.getPnum() %>
                                </td>
                                <td align="center"><a
                                        href="Pppeopleform.do?method=query&&id=<%=project1.getPid().toString()%>">
                                    <%=list2.get(i) %>
                                </a></td>
                                ...
                                <td align="center"><%=project1.getPstate1() %>
                                </td>
                                ...
                                <td align="center">
                                    ...
                                    <% }%>
                                    <%
                                        if (project1.getPstate1().equals("系审通过")) {%>
                                    <button class="btn btn-default btn-xs"><i class="icon-pencil">编辑</i></button>
                                    <% } else {
                                        if (project1.getUsernum().equals(keyanuser.getUsername())) {%>
                                    <a href="project1.do?method=update&&id=<%=project1.getPid().toString()%>">
                                    ...
                                    %>
                                    <% if (project1.getPstate1().equals("系审通过")) {%>
                                    <button class="btn btn-default btn-xs"><i class="icon-remove">删除</i></button>
                                    <%} else { %>
                                ...
                                <%if (userclasify.equals("0")) {%>
                                <td align="center">
                                    <%if (project1.getPstate2().equals("校审通过") && project1.getPstatus() == null) {%>
                                    <a href="project1.do?method=insert13&&id=<%=project1.getPid().toString()%>"
                                       onclick="return yesno2()">
                                        <button class="btn btn-success btn-xs"><i class="icon-external-link">申请立项</i>
                                        </button>
                                    </a>
                                    <%} else {%>
                                    <button class="btn btn-default btn-xs"><i class="icon-external-link">申请立项</i>
                                    </button>
                                    <%} %>
                                </td>
                                <%} %>
