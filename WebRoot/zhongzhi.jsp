  ...
  <section id="container" class="">
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="project1.do?method=query115">项目终止</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <thead>
                                  ...
                                  <%if(keyanuser.getUserclasify().equals("2")||keyanuser.getUserclasify().equals("1")) {%>                               
      ...
      %>
                          	<tr class="odd gradeX">                         		 
                                  ...
                                  <td align="center"><a href="Pppeopleform.do?method=query&&id=<%=project1.getPid().toString()%>"><%=list2.get(i) %></a></td>
                                  <td align="center"><%=project1.getPstate3() %></td>
                                  <td align="center"><%
			                                           ...
			                                           <%}else{%><button class="btn btn-default btn-xs"><i class="icon-download-alt">下载</i></button><%
                                  ...
                                  <td align="center">
                                  	<%if(keyanuser.getUserclasify().equals("1")){
														...
														<a href="project1.do?method=insert1152&&id=<%=project1.getPid().toString()%>"
															onclick="return yesno1()"><button class="btn btn-danger btn-xs"><i class="icon-remove ">不通过</i></button></a>
											             <%}} if(keyanuser.getUserclasify().equals("2")){
											             if(project1.getPstate3().equals("校审通过")){%>
														 <span class="label label-success "><i class="icon-ok">已通过</i></span>
														 <%}
											             else {%>
														<a href="project1.do?method=insert1151&&id=<%=project1.getPid().toString()%>"
														...
														<a href="project1.do?method=insert1152&&id=<%=project1.getPid().toString()%>"
															onclick="return yesno1()"><button class="btn btn-danger btn-xs"><i class="icon-remove ">不通过</i></button></a>	<%}} %>
										<a href="project1form.do?method=delete&&id=<%=project1.getPid().toString()%>"onclick="return yesno()"><button class="btn btn-danger btn-xs"><i class="icon-trash ">删除</i></button></a>
                                  </td><%} %>	
