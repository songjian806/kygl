...
function yzTitle()
{
  var id = projectcgForm.PTitle.value;
 
	var result = jsonrpc.ajax.yanzhengProjectcg(id);
	
    if(result==false)
    {
     alert("该项目已经存在！");
     projectcgForm.PTitle.value="";
     projectcgForm.PTitle.focus();
    }
}

function chongzhi(){
   projectcgForm.PTitle.value="";
   projectcgForm.PUnit.value="";
   projectcgForm.PId.value="";
   projectcgForm.POthers.value="";
    projectcgForm.PSecond.value="";
     projectcgForm.PThird.value="";
}
</script>
<script type="text/javascript">
function onsubmit1()
...
if(projectcgForm.PTitle.value=='')
{
  alert("项目名称不能为空");
  return false;
}
else if(projectcgForm.PUnit.value=='')
{
  alert("鉴定单位不能为空");
  return false;
}
else if(projectcgForm.PId.value=='')
{
  alert("项目鉴定编号不能为空");
  return false;
}
		...
		<section id="main-content">
          <section class="wrapper">
            ...
            <div class="row">
              <div class="col-lg-12">
			   <section class="panel">
                <header class="panel-heading"><strong> 添加项目</strong> </header>
				<div class="panel-body">
				<div class=" form">
					<form class="cmxform form-horizontal tasi-form" action="projectcg.do?method=insert" method="post"
						enctype="multipart/form-data" onsubmit="return onsubmit1()">
						 ...
						 <div class="form-group ">
								...
								<div class="col-lg-3">
									<input type="text" class="form-control" value="<%=name1 %>""
										name="PName" readonly="true"> 
								</div>
							
								<label class="control-label col-lg-2 col-lg-offset-1"  >职称</label>
								<div class="col-lg-3">
									<select class="form-control m-bot10" name="PPost">
						 ...
						 <div class="form-group ">
								...
								<div class="col-lg-3">
									<select class="form-control m-bot10" name="PDept">
								...
								<label class="col-lg-2 control-label col-lg-offset-1">项目名称
								</label>
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输入项目名称"
										name="PTitle" onblur="yzTitle()">
								</div>
							
						</div>
						
						 <div class="form-group ">
								<label for="inputEmail1" class="col-lg-2 control-label">项目鉴定或颁奖单位名称
								</label>
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输入项目鉴定或颁奖单位名称"
										name="PUnit">
								</div>
								...
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输入项目鉴定编号、获奖证书编号"
										name="PId">
								</div>
						 ...
						 <div class="form-group ">
								...
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输入第二作者"
										name="PSecond">
								</div>
								...
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输入第二作者学工号"
										name="PSecondnum">
								</div>
							</div>
                    ...
                    <div class="form-group ">
								...
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输入第三作者" name="PThird">
								</div>
							 
								<label class="col-lg-2 control-label col-lg-offset-1">第三作者
								</label>
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输入第三作者学工号" name="PThirdnum">
								</div>
							</div>
                     <div class="form-group ">
								...
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输其他参编人员(请按顺序填写,用“、”隔开)"
										name="POthers">
								</div>
					 
								<label for="inputEmail1" class="col-lg-2 control-label col-lg-offset-1">其他参编人员
								</label>
								<div class="col-lg-3">
									<input type="text" class="form-control" placeholder="请输其他参编人员学号(请按顺序填写,用“、”隔开)"
										name="POthersnum">
								</div>
							</div>
					 ...
					 <div class="form-group ">
                      ...
                      <div class="form-group ">
								...
								<div class="col-lg-3">
									<select class="form-control m-bot10" name="PRemarks">
								...
								<label class="col-lg-2 control-label col-lg-offset-1">文件上传(可省略)
								</label>
								<div class="col-lg-3">
