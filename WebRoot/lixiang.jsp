...
<html lang="en">
  ...
  <%
            ...
            list2=(List)getServletContext().getAttribute("list2");
				...
				int pagesize =1500000 ; //指定每页显示的记录数
				if(list1!=null)
				{
  ...
  <section id="container" class="">
                  ...
                  <ul class="sidebar-menu">
                      ...
                      <li class="sub-menu active">
                          ...
                          <ul class="sub">
                              ...
                              <li class="active"><a class="" href="project1.do?method=query111">项目立项</a></li>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <strong>立项基本信息列表</strong>                         
                          <button class="btn btn-sm btn-info pull-right" onclick="window.location.href='Shengxls4.do?method=project'"><i class="icon-cloud-download">导出Excel</i></button>                                        
                          </header>
                          ...
                          <thead>
                              <tr>                         		  
                                  ...
                                  <%}else{ %>
                                  <th style="width:10%"><div align="center">审核</div></th>
                                  <%} %>
                              </tr>
                           </thead>
                          <tbody>
      ...
      %>
                          	...
                          	<tr class="odd gradeX">                         		 
                                  ...
                                  <a href="xiazai.do?method=project1&&id=<%=project1.getPid().toString()%>"><button class="btn btn-success btn-xs"><i class="icon-download-alt">下载</i></button></a>
			                       ...
			                       <!--文件上传开始-->
			                        ...
			                        <div id="upload<%=id1 %>" style="display:none;z-index: 200;position: absolute;width: 200px;left: 200px;background-color: blue " >
			                                            <html:form action="project1.do?method=upload2" enctype="multipart/form-data">
                                  ...
                                  <td align="center"><%if(keyanuser.getUserclasify().equals("0")) { 
															if(project1.getPstate3().equals("未审核")) {
															%>
															<button class="btn btn-default btn-xs"><i class="icon-flag">中检申请</i></button>
															<a href="project1.do?method=insert1112&id=<%=project1.getPid().toString()%>"
															onclick="return yesno3()"><button class="btn btn-danger btn-xs"><i class="icon-warning-sign">终止申请</i></button></a>
															<%}
															else if(project1.getPstate3().equals("立项2")){
															%>
															   
														<a href="project1.do?method=insert1111&id=<%=project1.getPid().toString()%>"
															onclick="return yesno2()"><button class="btn btn-info btn-xs"><i class="icon-flag">中检申请</i></button></a>
														<a href="project1.do?method=insert1112&id=<%=project1.getPid().toString()%>"
															onclick="return yesno3()"><button class="btn btn-danger btn-xs"><i class="icon-warning-sign">终止申请</i></button></a>	
															<%} else {%>
															<button class="btn btn-default btn-xs"><i class="icon-flag">中检申请</i></button>
														...
														onclick="return yesno1()"><button class="btn btn-danger btn-xs"><i class="icon-remove">不通过</i></button></a>
															<%} else if(project1.getPstate3().equals("立项1")){ %>
