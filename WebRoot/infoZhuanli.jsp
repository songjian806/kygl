                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="modal-header">
                            <strong>专利详情查看</strong>
                        </header>
                        <div class="panel-body">
                            <div class=" form">
                                <div class="cmxform form-horizontal tasi-form" id="commentForm">
                                    <div class="form-group ">
                                        <label class="control-label col-lg-2"><strong>学工号：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZnamenum() %>
                                        </label>
                                        <label class="control-label col-lg-2"><strong>发明人：</strong></label>
                                        <label class="control-label col-lg-4"><%=name1 %>
                                        </label>


                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-2"><strong>职称：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZPost() %>
                                        </label>
                                        <label class="control-label col-lg-2"><strong>所在单位：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZDept() %>
                                        </label>

                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label col-lg-2"><strong>专利名称：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZTitle() %>
                                        </label>
                                        <label class="control-label col-lg-2"><strong>专利类型：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZType() %>
                                        </label>

                                    </div>
                                    <div class="form-group">
                                        <label
                                                class="control-label col-lg-2"><strong>项目名称及编号：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZNum() %>
                                        </label>
                                        <label class="control-label col-lg-2"><strong>状态：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZState() %>
                                        </label>

                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-lg-2"><strong>申请（授权号）：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZNum() %>
                                        </label>
                                        <label class="control-label col-lg-2"><strong>申请（授权日）：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZTime().toString() %>
                                        </label>

                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-2"><strong>第二作者：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getSecond() %>
                                        </label>
                                        <label class="control-label col-lg-2"><strong>第三作者：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getThird() %>
                                        </label>

                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-lg-2"><strong>其他参与人员：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZOthers() %>
                                        </label>
                                        <label class="control-label col-lg-2"><strong>奖励：</strong></label>
                                        <label class="control-label col-lg-4"><%=zhuanli.getZAward() %>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="cname" class="control-label col-lg-4"><%=zhuanli.getZScore() %>
                                        </label>
                                        <label for="cname"
                                               class="control-label col-lg-2"><strong>备注（等级）：</strong></label>
                                        <label for="cname" class="control-label col-lg-4"><%=zhuanli.getZRemarks() %>
                                        </label>
