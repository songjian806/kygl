...
keyanuser=(Keyanuser)getServletContext().getAttribute("user");
                  ...
                  <aside class="profile-nav col-lg-3">
                      <section class="panel">
                          ...
                          <ul class="nav nav-pills nav-stacked">
                              <li><a href="userList1.jsp"> <i class="icon-user"></i>个人信息</a></li>
                              <li  class="active"><a href="user.do?method=query2&&id=<%=keyanuser.getId().toString() %>"> <i class="icon-edit"></i> 修改个人信息</a></li>
                          </ul>
                  ...
                  <aside class="profile-info col-lg-9">
                      <section class="panel">
                          ...
                          <div class="panel-body bio-graph-info">
                              <h1>个人信息</h1>
                              <form class="form-horizontal" action="user.do?method=update1" method="post">
                                  <input name="id" type="hidden" value="<%=keyanuser.getId().toString()%>"/> 
                                  <div class="form-group">
                                      <label  class="col-lg-2 control-label">用户名</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" id="f-name" readonly="true" value=" <%=keyanuser.getUsername() %>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label  class="col-lg-2 control-label">姓名</label>
                                      <div class="col-lg-6">
                                          <input type="text" readonly="true" class="form-control" id="l-name" placeholder="<%=keyanuser.getName() %> ">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label  class="col-lg-2 control-label">所在单位</label>
                                      <div class="col-lg-6">
                                          <input type="text" readonly="true" class="form-control" id="c-name" placeholder="<%=keyanuser.getUserdept() %> ">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label  class="col-lg-2 control-label">角色</label>
                                      <div class="col-lg-6">
                                          <input type="text" readonly="true" class="form-control" id="b-day" placeholder=" <%=keyanuser.getLevel() %>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label  class="col-lg-2 control-label">职称</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" id="occupation" name="post" value="<%=keyanuser.getPost() %>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label  class="col-lg-2 control-label">联系电话</label>
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" id="mobile" name="tel" value=" <%=keyanuser.getTel() %>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label  class="col-lg-2 control-label">居住地址</label>
                                      <div class="col-lg-10">
                                          <input name="addr" id="" class="form-control" cols="30" rows="10" value="<%=keyanuser.getAddr() %>"></input>
                                      </div>
                                  </div>
