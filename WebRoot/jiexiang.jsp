...
<html lang="en">
  ...
  <%
		     ...
		     int Page = 1;
				...
				int pagesize = 100000000; //指定每页显示的记录数
				if(list1!=null)
				{
              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="project1.do?method=query113">项目结项</a></li>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <thead>
                                  ...
                                  <th><div align="center"> 审核</div></th>
                                  <%}else{ %>
                                  <th><div align="center"> 申请</div></th>
                                  <%} %>
                              </tr>
                           </thead>
                          <tbody>
      ...
      %>  
       ...
       <%=list2.get(i) %></a></td>
				  ...
				  <td align="center"><%=project1.getUsernum() %></td>
                                  ...
                                  if(project1.getPstate3().equals("结项1")){
          out.print("系审通过");
       }else if(project1.getPstate3().equals("结项2")){
         out.print("系审通过");
       }
       else if(project1.getPstate3().equals("结项11")){
         out.print("系审不通过");
       }else if(project1.getPstate3().equals("结项22")){
         out.print("系审通过");
       }   else {out.print("未审核");}
        ...
        %></td>
                                  ...
                                  <td align="center">
                                 		...
                                 		<%
			                                           ...
			                                           <%} %>
			                                            ...
			                                            <html:form action="project1.do?method=upload3" enctype="multipart/form-data">
                                  ...
                                  <%if(keyanuser.getUserclasify().equals("0")){ %>
                                  <td align="center">
                                  <%if(project1.getPstate3().equals("结项11")||project1.getPstate3().equals("结项22")) {%>
														<a href="project1.do?method=insert1131&&id=<%=project1.getPid().toString()%>"
															onclick="return yesno2()"><button class="btn btn-warning btn-xs"><i class="icon-time ">延期</i></button></a>
															<%}else {%><button class="btn btn-default btn-xs"><i class="icon-time ">延期</i></button><%} %>
                                  </td>
                                   <%}%> 
                                   
                                   <%if(keyanuser.getUserclasify().equals("1")){ %>
                                   <td align="center">
                                   	<%	if(project1.getPstate3().equals("结项1")||project1.getPstate3().equals("结项2"))
															{%>
														...
														<a href="project1.do?method=insert1132&&id=<%=project1.getPid().toString()%>"
                                   ...
                                   <%if(keyanuser.getUserclasify().equals("2")){ %>
                                   <td align="center">
                                   	<%	if(project1.getPstate3().equals("结项2"))
															{%>
														 <span class="label label-success "><i class="icon-ok">已通过</i></span>
														 <%
														}else{ %> 
