                              ...
                              <div class=" form">
                                  <div class="cmxform form-horizontal tasi-form" id="commentForm" >
                                      <div class="form-group ">
                                          ...
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWnum()%></label>
                                          <label for="cname" class="control-label col-lg-2"><strong>主编：</strong></label>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWPost() %></label>
                                          <label for="cname" class="control-label col-lg-2"><strong>所在单位：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWUnit() %></label>
										  
                                      </div>
                                      <div class="form-group ">
                                      <label for="cname" class="control-label col-lg-2"><strong>论著（教材）名称：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWTitle() %></label>
                                          <label for="cname" class="control-label col-lg-2"><strong>出版社：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWPublisher() %></label>
										  
                                      </div>
                                      <div class="form-group">
                                      <label for="cname" class="control-label col-lg-2"><strong>ISBN书号：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWIsbnid() %></label>
                                          <label for="cname" class="control-label col-lg-2"><strong>其他参编人员：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWOthers() %></label>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <label for="cname" class="control-label col-lg-4"><%=work.getSecond() %></label>
										  <label for="cname" class="control-label col-lg-2"><strong>第三作者：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getThird() %></label>
                                      </div>
                                      <div class="form-group">
                                          <label for="cname" class="control-label col-lg-2"><strong>发表时间：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWTime().toString() %></label>
                                          <label for="cname" class="control-label col-lg-2"><strong>审核状态：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWScore() %></label>
										  
                                      </div>
                                      <div class="form-group">
                                      <label for="cname" class="control-label col-lg-2"><strong>备注（等级）：</strong></label>
                                          <label for="cname" class="control-label col-lg-4"><%=work.getWRemarks() %></label>
                                      </div>
