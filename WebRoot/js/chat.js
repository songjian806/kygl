	  ...
	  break;
       ...
       case 'join' :
       {
	    ...
	    amq.sendMessage(this._chatTopic, "<message type='ping' from='" + room._username + "'/>");
          chat.innerHTML += "<span class=\"alert\"><span class=\"from\">"+from+"&nbsp;</span><span class=\"text\">\u8FDB\u5165\u804A\u5929\u5BA4</span></span><br/>";
	  break;
       }
       ...
       case 'leave':
       {
          ...
          if (room._username!=null)
            amq.sendMessage(this._chatTopic, "<message type='ping' from='" + room._username + "'/>");
          chat.innerHTML += "<span class=\"alert\"><span class=\"from\">"+from+"&nbsp;</span><span class=\"text\">\u79BB\u5F00\u4E86\u804A\u5929\u5BA4</span></span><br/>";
	  break;
       }
     }
