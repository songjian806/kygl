              ...
              <ul class="sidebar-menu">
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a class="" href="project1.do?method=query114">项目延期</a></li>
          ...
          <section class="wrapper">
              ...
              <div class="row">
				  ...
				  <th><div align="center">负责人学工号</div></th>
                                  ...
                                  <th><div align="center">基本操作</div></th>                                 
         ...
         { 
          ...
          out.print("系审不通过");}
                                  ...
                                  <td align="center"><%
															...
															{
															 %>
															<a href="xiazai.do?method=project1&&id=<%=project1.getPid().toString()%>"><button class="btn btn-success btn-xs"><i class="icon-download-alt ">下载</i></button></a></a>
			                                           <%}else{%>
			                                         ...
			                                         <!--文件上传开始-->
			                                            ...
			                                            <html:form action="project1.do?method=upload" enctype="multipart/form-data">
                                  ...
                                  <td align="center">
                                  	<%if(keyanuser.getUserclasify().equals("1")) {
														...
														%>
														<a href="project1.do?method=insert1141&&id=<%=project1.getPid().toString()%>"
															onclick="return yesno2()"><button class="btn btn-success btn-xs"><i class="icon-external-link">结项申请</i></button></a>
														<%} else {%><button class="btn btn-default btn-xs"><i class="icon-external-link">结项申请</i></button><%} }%>
                                  </td>
